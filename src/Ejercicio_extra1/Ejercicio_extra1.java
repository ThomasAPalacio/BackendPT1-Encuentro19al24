...
//para construir el objeto a través de un método constructor. Luego, en RaicesServicio las operaciones 
...
public class Ejercicio_extra1 {
    ...
    public static void main(String[] args) {
        ...
        RaicesServicio servicios=new RaicesServicio();
        RaicesEntidad ra=servicios.crearRaiz();
        servicios.calcular(ra);       
