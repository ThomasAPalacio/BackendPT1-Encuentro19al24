...
//de la siguiente manera: Para calcular la letra se toma el resto de dividir el número 
//de DNI por 23 (el resultado debe ser un número entre 0 y 22). El método debe buscar 
//en un array (vector) de caracteres la posición que corresponda al resto de la división 
...
public class Ejercicio_extra2 {
    ...
    public static void main(String[] args) {
        ...
        NifServicio servicios = new NifServicio();
        servicios.mostrar();
